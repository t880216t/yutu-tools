...
function startRecorder(options){
    ...
    var raw = options.raw;
    var browserSize = options.browserSize || '';
        ...
        function onReady(serverAddress, serverPort){
            ...
            setTimeout(function(){
                createBrowser({
                    ...
                    console.log(`consoleParams:{"sessionId": "${browser.lastBrowser?.sessionId}", "type": "main"}`);
                ...
                configJson.webdriver?.syncBrowsers && configJson.webdriver?.syncBrowsers.map(browserInfo => {
                    setTimeout(function(){
                        createBrowser({
                            ...
                            console.log(`consoleParams:{"sessionId": "${browser.lastBrowser?.sessionId}", "type": "sync", "browserInfo": "${browserInfo.browserName}:${browserInfo.version}"}`);
                            console.log('');
...
function createBrowser(options, callback) {
    ...
    if (options.browserSize){
        capabilities["screenResolution"] = options.browserSize
    }
