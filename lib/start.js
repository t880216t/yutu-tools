...
function startRecorder(options){
    ...
    inquirer.prompt(questions).then(function(answers){
        ...
        function saveTestCode(success, error, browserName='', version=''){
        ...
        var cmdQueue = async.priorityQueue(function(cmdInfo, next) {
            ...
            arrTasks.push(function(callback){
                ...
                function doNext(browserName='', version='' ){
                    saveTestCode(true, '',browserName, version);
                }
                function catchError(error, browserName='', version=''){
                    saveTestCode(false, error, browserName, version);
                }
                if(window !== lastWindowId){
                    ...
                    syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(500).switchWindow(window).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                    callback();
                }
                else{
                    callback();
            ...
            arrTasks.push(function(callback){
                ...
                if(frame !== lastFrameId){
                    ...
                    }).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                    callback();
                }
                else{
                    callback();
                ...
                if(mobile){
                    ...
                    switch(cmd){
                        case 'url':
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.url(getVarStr(eval('\`'+data+'\`'))).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'closeWindow':
                            pushTestCode('closeWindow', '', '', 'await driver.closeWindow();');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.closeWindow().then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'sleep':
                            pushTestCode('sleep', '', data, 'await driver.sleep('+data+');');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(data).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'waitBody':
                            arrCodes = [];
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser =>
                                browser.sleep(500)
                                    ...
                                    .then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version))
                                    .catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'eval':
                            pushTestCode('eval', '', data.replace(/\n/g, ' \\n '), 'await driver.eval(_(\''+escapeStr(data)+'\'));');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.eval(getVarStr(data)).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'mouseMove':
                            arrCodes = [];
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, 10000).sleep(300).mouseMove(data.x, data.y).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'mouseDown':
                            arrCodes = [];
                            arrCodes.push('await driver.sleep(300).wait(\''+escapeStr(data.path)+'\', 30000)');
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, 10000).sleep(300).mouseMove(data.x, data.y).mouseDown(data.button).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'mouseUp':
                            arrCodes = [];
                            arrCodes.push('await driver.sleep(300).wait(\''+escapeStr(data.path)+'\', 30000)');
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, 10000).sleep(300).mouseMove(data.x, data.y).mouseMove(data.x, data.y).mouseUp(data.button).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'click':
                            arrCodes = [];
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, 10000).sleep(300).mouseMove(data.x, data.y).click(data.button).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'touchClick':
                            arrCodes = [];
                            arrCodes.push('await driver.sleep(300).wait(\''+escapeStr(data.path)+'\', 30000)');
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, 10000).sleep(300).touchClick().then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'dblClick':
                            arrCodes = [];
                            arrCodes.push('await driver.sleep(300).wait(\''+escapeStr(data.path)+'\', 30000)');
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, 10000).sleep(300).mouseMove(data.x, data.y).click(0).click(0).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'sendKeys':
                            pushTestCode('sendKeys', '', data.keys, 'await driver.sendKeys(\''+escapeStr(data.keys)+'\');');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sendKeys(data.keys).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'keyDown':
                            pushTestCode('keyDown', '', data.character, 'await driver.keyDown(\''+escapeStr(data.character)+'\');');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.keyDown(data.character).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'keyUp':
                            pushTestCode('keyUp', '', data.character, 'await driver.keyUp(\''+escapeStr(data.character)+'\');');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.keyUp(data.character).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'scrollTo':
                            pushTestCode('scrollTo', '', data.x + ', ' + data.y, 'await driver.scrollTo('+data.x+', '+data.y+');');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.scrollTo(data.x, data.y).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'scrollElementTo':
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, 10000).sleep(300).scrollElementTo(data.x, data.y).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'select':
                            arrCodes = [];
                            arrCodes.push('await driver.sleep(300).wait(\''+escapeStr(data.path)+'\', 30000)');
                        ...
                        case 'acceptAlert':
                            pushTestCode('acceptAlert', '', '', 'await driver.acceptAlert();');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.acceptAlert().then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'dismissAlert':
                            pushTestCode('dismissAlert', '', '', 'await driver.dismissAlert();');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.dismissAlert().then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'setAlert':
                            pushTestCode('setAlert', '', data.text, 'await driver.setAlert("'+data.text+'");');
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.setAlert(data.text).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        case 'uploadFile':
                            arrCodes = [];
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, {timeout: 10000, displayed: false})
                                .sleep(300).sendElementKeys(rootPath+'/uploadfiles/'+data.filename).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        // 添加断言
                        case 'expect':
                        ...
                        case 'insertVar':
                           ...
                           if(varinfo.isNew){
                            ...
                            syncCheckBrowserDrivers && syncCheckBrowserDrivers.forEach(browser => browser.sleep(300).wait(data.path, 10000).val(getVarStr(eval('\`'+varinfo.template+'\`'))).then(doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version)).catch(e => catchError(e, browser.lastBrowser?.browserName, browser.lastBrowser?.version)) || doNext(browser.lastBrowser?.browserName, browser.lastBrowser?.version));
                            break;
                        // 更新变量
                        case 'updateVar':
                            co(function*(){
        ...
        function onReady(serverAddress, serverPort){
            ...
            // recorder browser
            setTimeout(function(){
                newChromeBrowser({wdPort: wdPort, hosts: hosts, wdPacUrl: wdPacUrl, isRecorder: true, debug: debug, browserName: configJson.webdriver.mainBrowser.browserName, version: configJson.webdriver.mainBrowser.version }, function*(browser){
                    if(!mobile){
                        if (browserSize) {
            ...
            if(mobile){
                ...
                configJson.webdriver?.syncBrowsers && configJson.webdriver?.syncBrowsers.map(browserInfo => {
                    setTimeout(function(){
                        newChromeBrowser({ wdPort: wdPort, hosts: hosts, wdPacUrl: wdPacUrl, isRecorder: false, debug: debug, browserName: browserInfo.browserName, version: browserInfo.version }, function*(browser){
                            if(browserSize){
                                yield browser.windowSize(browserSize[0], browserSize[1]);
                            }
                            else {
                            ...
                            console.log(`${__('checker_browser_opened')}: ${browserInfo.browserName}`.green);
                            console.log('');
