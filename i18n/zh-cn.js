{
    ...
    "continue_to_record": "文件已存在，加载并继同步吗？",
    ...
    "exec_succeed": "执行成功",
    "exec_failed": "执行失败",
    "recorder_browser_opened": "主控浏览器已开启",
    "recorder_browser_title": "主控浏览器",
    "checker_browser_opened": "同步浏览器已开启",
    "checker_browser_title": "同步浏览器",
    "recorder_server_closed": "主控服务器已关闭",
    "recorder_browser_closed": "主控浏览器已关闭",
    "checker_browser_closed": "校验浏览器已关闭",
    "test_spec_saved": "同步脚本已保存: ",
    "raw_cmds_saved": "原数据已保存: ",
    "config_saved": "配置已保存: ",
    "check_sumary": "共同步%s个步骤，其中校验通过: %s个，校验失败: %s个",
    "no_step_recorded": "无步骤同步！",
    "nocheck_sumary": "共同步%s个步骤 %s",
    "nocheck": "未经过校验",
    "recorder_server_listen_on": "同步服务器监听在端口: %s",
    ...
    "chrome": {
        ...
        "start_button": "开始同步",
        "icon_record_tip": "操作同步中……点击结束",
        "icon_end_tip": "操作同步已结束",
        "icon_end_msg": "操作同步已经结束，请从客户端重新初始化！",
        "module_start_title": "脚本加载开始",
        "module_start_message": "开始加载脚本: %s，加载过程中请勿进行任何键盘和鼠标操作。",
        "module_end_title": "脚本加载结束",
        "module_end_message": "脚本加载%s: %s，请继续同步操作。",
        "exec_succeed": "执行成功",
        "exec_failed": "执行失败",
        "succeed": "成功",
        "failed": "失败",
